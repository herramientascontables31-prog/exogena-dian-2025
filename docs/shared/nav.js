...
(function(){
  ...
  '    </div>'+
       /* Escuela link */
  '    <a href="escuela.html" class="tn-cat-btn" style="background:linear-gradient(135deg,#EA580C,#F97316);color:#fff;border-color:transparent;font-weight:800;box-shadow:0 2px 10px rgba(234,88,12,.25);text-decoration:none;font-size:.82rem">📖 Escuela</a>'+
  '  </div>'+
  ...
  '    <a href="ia.html" style="display:inline-flex;align-items:center;gap:6px;padding:8px 18px;background:linear-gradient(135deg,#059669,#10B981);color:#fff;border-radius:12px;font-size:.9rem;font-weight:800;text-decoration:none;transition:all .2s;box-shadow:0 3px 12px rgba(5,150,105,.35);letter-spacing:.02em;animation:iaGlow 3s ease-in-out infinite"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446A9 9 0 1 1 8.89 3.89"/><path d="m17 3-2 2 2 2"/><path d="m22 6-2 2 2 2"/></svg>IA Contable</a>'+
       /* Escuela CTA */
  '    <a href="escuela.html" style="display:inline-flex;align-items:center;gap:6px;padding:8px 18px;background:linear-gradient(135deg,#EA580C,#F97316);color:#fff;border-radius:12px;font-size:.9rem;font-weight:800;text-decoration:none;transition:all .2s;box-shadow:0 3px 12px rgba(234,88,12,.35);letter-spacing:.02em"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>Escuela</a>'+
       /* Precios link */
  '    <a href="precios.html" style="display:inline-flex;align-items:center;gap:5px;padding:8px 16px;background:#F59E0B;color:#fff;border-radius:12px;font-size:.88rem;font-weight:800;text-decoration:none;transition:all .2s;box-shadow:0 3px 10px rgba(245,158,11,.3)">Precios</a>'+
       /* PRO Login */

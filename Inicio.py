...
with col1:
    ...
    """, unsafe_allow_html=True)
    st.page_link("pages/1_📋_Generar_Formatos.py", label="Ir a Generar Formatos →", icon="📋")
...
with col2:
    ...
    """, unsafe_allow_html=True)
    st.page_link("pages/2_🔍_Prevalidador_XML.py", label="Ir a Prevalidador XML →", icon="🔍")

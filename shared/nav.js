...
(function(){
  ...
  '    </div>'+
       /* Escuela link */
  '    <a href="escuela.html" style="display:inline-flex;align-items:center;gap:4px;padding:6px 14px;border:1px solid #FFEDD5;border-radius:8px;background:#FFF7ED;font-size:.82rem;font-weight:600;color:#EA580C;text-decoration:none;transition:all .15s;white-space:nowrap" onmouseover="this.style.background=\'#FFEDD5\';this.style.borderColor=\'#F97316\'" onmouseout="this.style.background=\'#FFF7ED\';this.style.borderColor=\'#FFEDD5\'">📖 Escuela</a>'+
  '  </div>'+
  ...
  '    <a href="renta110.html">Renta F110</a>'+
  '    <a href="regimen-simple.html">Régimen Simple</a>'+
       /* Mega-menu dropdown */
  ...
  '    <a href="ia.html" style="display:inline-flex;align-items:center;gap:6px;padding:8px 18px;background:linear-gradient(135deg,#059669,#10B981);color:#fff;border-radius:12px;font-size:.9rem;font-weight:800;text-decoration:none;transition:all .2s;box-shadow:0 3px 12px rgba(5,150,105,.35);letter-spacing:.02em;animation:iaGlow 3s ease-in-out infinite"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446A9 9 0 1 1 8.89 3.89"/><path d="m17 3-2 2 2 2"/><path d="m22 6-2 2 2 2"/></svg>IA Contable</a>'+
       /* Escuela CTA */
  '    <a href="escuela.html" style="text-decoration:none;color:#6B7280;font-size:.88rem;font-weight:500;transition:color .2s;display:inline-flex;align-items:center;gap:5px" onmouseover="this.style.color=\'#EA580C\'" onmouseout="this.style.color=\'#6B7280\'"><span style="width:6px;height:6px;background:#F97316;border-radius:50%;flex-shrink:0"></span>Escuela</a>'+
       /* Precios link */
  '    <a href="precios.html" style="text-decoration:none;color:#6B7280;font-size:.88rem;font-weight:500;transition:color .2s" onmouseover="this.style.color=\'#111827\'" onmouseout="this.style.color=\'#6B7280\'">Precios</a>'+
       /* PRO Login */
